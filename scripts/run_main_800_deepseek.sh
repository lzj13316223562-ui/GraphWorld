...
echo "GraphWorld DeepSeek 800-step grid: steps=${STEPS}, schedules=${SCHEDULES_CSV}, agent_model=${AGENT_MODEL}, vllm_model=${VLLM_MODEL}"
...
echo "===== finished deepseek 800-step grid $(date -Is) ====="
