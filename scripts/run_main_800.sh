...
echo "GraphWorld Qwen 800-step grid: steps=${STEPS}, schedules=${SCHEDULES_CSV}, agent_model=${AGENT_MODEL}, vllm_model=${VLLM_MODEL}"
...
echo "===== finished qwen 800-step grid $(date -Is) ====="
