...
STEPS="${STEPS:-800}"
AGENT_MODEL="${AGENT_MODEL:-vllm-llama3.1-8b}"
VLLM_BASE_URL="${VLLM_BASE_URL:-http://127.0.0.1:8000/v1}"
VLLM_MODEL="${VLLM_MODEL:-llama-3.1-8b}"
...
echo "GraphWorld Llama 3.1 800-step grid: steps=${STEPS}, schedules=${SCHEDULES_CSV}, agent_model=${AGENT_MODEL}, vllm_model=${VLLM_MODEL}"
...
echo "===== finished llama3.1 800-step grid $(date -Is) ====="
